                ...
                var pokemonOwners = new List<PokemonOwner>()
                {
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                ...
                                new Review { Title="Pikachu", Text = "Pickachu is the best a killing rocks", Rating =3,
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review { Title= "Squirtle", Text = "squirtle is the best pokemon, because it is electric", Rating =2,
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                    ...
                                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                ...
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title="Veasaur",Text = "Venasuar is the best a killing rocks", Rating =2,
                                Reviewer = new Reviewer(){ FirstName = "Taylor", LastName = "Jones" } },
